...
CLASS lhc_zco002_dd_kal_bak_blg_yrt IMPLEMENTATION.
  ...
  METHOD call_journal_entry.
    DATA: lt_data    TYPE ztrm000_journal_entry_crea_tab, "zjournal_entry_create_requ_tab,
    ...
    LOOP AT ct_bakiye ASSIGNING FIELD-SYMBOL(<lfs_bakiye>) GROUP BY ( costcenter = <lfs_bakiye>-costcenter ).
      ...
      DATA(lo_destination) = cl_soap_destination_provider=>create_by_comm_arrangement(
        comm_scenario = 'ZTRM000_CS_JOURNAL_ENTRY'"'ZTRM000_CS_JOURNAL_ENTRY_V2'"ZTRM000_CS_JOURNAL_ENTRY_CREAT'"'ZFI000_CS_JOURNEYENTRY'
      ).
...
*      DATA(lo_destination) = cl_soap_destination_provider=>create_by_comm_arrangement(
*        comm_scenario = 'ZTRM000_CS_JOURNAL_ENTRY'"'ZTRM000_CS_JOURNAL_ENTRY_V2'"ZTRM000_CS_JOURNAL_ENTRY_CREAT'"ZTRM000_CS_JOURNAL_ENTRY'"'ZFI000_CS_JOURNEYENTRY'
*      ).
*
